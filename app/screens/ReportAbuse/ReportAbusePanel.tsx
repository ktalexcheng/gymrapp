...
import { Button, Divider, Icon, RowView, Spacer, Text, TextField } from "../../components"
...
export const ReportAbusePanel = (props: ReportAbusePanelProps) => {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange} dismissOnSnapToBottom={true} zIndex={zIndex}>
      <Sheet.Overlay />
      <Sheet.Handle alignSelf="center" style={$panelDraggableIndicator} />
      <Sheet.Frame style={$panelContainer}>{renderReportAbuseContent()}</Sheet.Frame>
    </Sheet>
  )
}
