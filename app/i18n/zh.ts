...
const zh: Translations = {
  ...
  profileScreen: {
    ...
    dashboardExercisesCoverageTitle: "動作分佈",
    dashboardExercisesCoverageInfo: "每個動作類別的訓練組數",
    dashboardExercisesCoverageLast7DaysLabel: "過去一週",
    dashboardExercisesCoverageLast30DaysLabel: "過去一月",
    dashboardExercisesCoverageAllTimeLabel: "全部",
    dashboardExercisesCoverageNoDataMessage: "所選擇的時間範圍中沒有動作紀錄",
  ...
  exerciseDetailsScreen: {
    ...
    noExerciseHistoryFound: "你還沒有這項動作的訓練記錄",
