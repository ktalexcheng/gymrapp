...
const zh: Translations = {
  ...
  editProfileForm: {
    ...
    error: {
      userHandleMissingMessage: "請輸入用戶代號",
      userHandleIsTakenMessage: "此用戶代號已被使用",
      userHandleInvalidMessage: "用戶代號僅能包含 30 個以内的英文字母、數字、下劃線和句點",
  ...
  userSettingsScreen: {
    ...
    deleteAccountAlertMessage: "這將移除你的所有訓練記錄以及帳戶資料。此操作無法復原。你確定嗎？",
  },
  newActivityScreen: {
  ...
  workoutSummaryScreen: {
    ...
    newRecordsMessageForOthers:
      "恭喜 {{userDisplayName}}！他達成了 {{newRecordsCount}} 個新的個人紀錄！",
  },
  exerciseSummary: {
  ...
  createNewGymScreen: {
    ...
    checkingGymExistsLabel: "檢查健身房是否存在...",
