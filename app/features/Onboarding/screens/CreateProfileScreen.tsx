...
import { AboutYouForm } from "app/features/UserProfile/components/AboutYouForm"
import { UserPreferencesMenu } from "app/features/UserProfile/components/UserPreferencesMenu"
        ...
        <RowView style={$indicators}>
          {onboardingScreens.map((_, index) =>
            currentPageIndex === index ? (
              <Text
                key={`createProfileProgress_${index}`}
                text={"●"}
                textColor={themeStore.colors("logo")}
                size="lg"
              />
